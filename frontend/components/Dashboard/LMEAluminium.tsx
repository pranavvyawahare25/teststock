...
// Format we use in our component
...
export default function LMEAluminium() {
  ...
  // Hard-coded Spot Price
  const SPOT_PRICE = 2700.0;
  ...
  // Hard-coded spot price change values
  const SPOT_CHANGE = 13.0;
  const SPOT_CHANGE_PERCENT = 0.48;
  ...
  useEffect(() => {
    ...
    const fetchDataAndUpdate = async () => {
      try {
        ...
        setIsConnected(success); // Show as "connected" when polling is working
      } catch (err) {
          ...
          <div className="bg-white rounded-xl p-6 sm:p-8 shadow-xl w-full max-w-4xl mx-4 max-h-[90vh] overflow-auto border border-gray-200">
            <div className="flex items-center justify-between w-full mb-6 sm:mb-8">
              <div className="flex items-center gap-3 sm:gap-4">
                ...
                {isConnected && (
                  <span className="bg-green-100 text-green-800 text-xs sm:text-sm px-2.5 py-1 rounded-full flex items-center">
...
// this is the alternative code for the LMEAluminium component
