...
export default function Sidebar({
  ...
  return (
    <>
      ...
      {/* Sidebar */}
      <div
        className={`fixed inset-y-0 left-0 bg-white/60 backdrop-blur-md border-r border-white/30 transition-all duration-300 ease-in-out z-40
      ...
      >
        ...
        <div className="flex flex-col h-full max-w-sm mx-auto md:max-w-none">
          {/* Logo or Brand */}
